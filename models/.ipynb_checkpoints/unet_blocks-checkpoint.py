# Adapted from https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/unet_d_blocks.py
...
class CrossAttnDownBlock3D(nn.Module):  ###相比官方文档，去掉了temp_conv和temp_attn，取而代之的是加入了inter_frame
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
